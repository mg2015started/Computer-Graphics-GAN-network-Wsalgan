...
import cPickle
import vgg19
from constants import PATH_TO_VGG19_WEIGHTS


def set_pretrained_weights(net, path_to_model_weights=PATH_TO_VGG19_WEIGHTS):
    # Set out weights
...
def build_encoder(input_height, input_width, input_var):
    encoder = vgg19.build(input_height, input_width, input_var)
